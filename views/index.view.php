...
<body>
    <div class="app-container" style="background-image: url('<?php echo e($bg_path);?>'); ">
        <div class="top-bar">
        ...
        <div class="weather-info">
            <img class="weather-info__image" src="<?php echo e($icon_path);?>" alt="Stormy" />
            <h1 class="weather-info__temperature"><?php echo e($info->temperatureC); ?></h1>
